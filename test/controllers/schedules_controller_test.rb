...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { memo: @schedule.memo, title: @schedule.title } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { memo: @schedule.memo, title: @schedule.title } }
